...
import com.example.saga.order.domain.port.input.CompleteOrderUseCase;
...
/**
 * Servicio de aplicación para completar órdenes.
 */
@Service
@Slf4j
@RequiredArgsConstructor
public class CompleteOrderApplicationService implements CompleteOrderUseCase {
